...
> - `develop` (`2621bee`) integra las **Fases 13 a 22**. La Fase 23 (formalización en PowerDesigner) está implementada en `feature/phase-23-powerdesigner` y pendiente de auditoría; la Fase 24 **no se inició**. *(Actualizado en la Fase 23; hasta entonces decía `aced6da`, Fases 13 a 21, la Fase 22 pendiente de auditoría y la Fase 23 sin iniciar. En la Fase 22 se había actualizado desde `a316c07`, Fases 13 a 20 y la Fase 21 pendiente de cierre.)*
