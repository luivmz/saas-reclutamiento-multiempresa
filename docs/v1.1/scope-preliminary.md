...
> - `develop` (`4469128`) integra las **Fases 13 a 24**; la Fase 24 (Formato 09) se cerró con observaciones. La Fase 25 (QA global final) está implementada en `feature/phase-25-final-qa` y pendiente de auditoría; la Fase 26 (GitHub, *release* y cierre de v1.1) **no se inició**. El Formato 09 v1.1 mantiene RF-01 a RF-27 como línea base y presenta RF-28, RF-29 y RNF-C como candidatos, sin promoverlos. *(Actualizado en la Fase 25; hasta entonces decía `8211851`, Fases 13 a 23, la Fase 24 pendiente de auditoría y las Fases 25 y 26 sin iniciar. En la Fase 24 se había actualizado desde `2621bee`, Fases 13 a 22, la Fase 23 pendiente de auditoría y la Fase 24 sin iniciar. En la Fase 23 se había actualizado desde `aced6da`, Fases 13 a 21, la Fase 22 pendiente de auditoría y la Fase 23 sin iniciar; en la Fase 22, desde `a316c07`, Fases 13 a 20 y la Fase 21 pendiente de cierre.)*
